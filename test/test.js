...
describe('prepend-if', () => {
  ...
  describe('custom condition function', () => {
    const customCondition = (string, prependString) => string.length > prependString.length
